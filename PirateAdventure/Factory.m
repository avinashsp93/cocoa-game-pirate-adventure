...
-(NSArray *)tiles {
    ...
    tile1.backgroundImage = [UIImage imageNamed:@"tile1_blunted_sword.jpg"];
    ...
    tile2.backgroundImage = [UIImage imageNamed:@"tile2_steel_armor.jpg"];
    ...
    tile3.backgroundImage = [UIImage imageNamed:@"tile3_pirate_friendly_dock.jpg"];
    ...
    tile4.backgroundImage = [UIImage imageNamed:@"tile4_parrot_armor.jpg"];
    ...
    tile5.backgroundImage = [UIImage imageNamed:@"tile5_pirate_pistol.jpg"];
    ...
    tile6.backgroundImage = [UIImage imageNamed:@"tile6_walk_the_plank.jpg"];
    ...
    tile7.backgroundImage = [UIImage imageNamed:@"tile7_pirate_fight.jpg"];
    ...
    tile8.backgroundImage = [UIImage imageNamed:@"tile8_abandoned_ship.jpg"];
    ...
    tile9.backgroundImage = [UIImage imageNamed:@"tile9_pirate_treasures.jpg"];
    ...
    tile10.backgroundImage = [UIImage imageNamed:@"tile10_pirate_invasion.jpg"];
    ...
    tile11.backgroundImage = [UIImage imageNamed:@"tile11_swimming_in_the_deep.jpg"];
    tile11.healthEffect = -7;
    tile11.actionButtonName = @"Swim deeper";

    Tile *tile12 = [[Tile alloc] init];
    tile12.story = @"Your final faceoff with the pirate boss!!";
    tile12.backgroundImage = [UIImage imageNamed:@"tile12_pirate_boss.jpg"];
